...
import { TTSProvider } from "../components/netra/LanguageAndTTS";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Official mobile companion app for NETRA-RAIL" },
      { name: "author", content: "Ministry of Railways · Government of India" },
      { property: "og:title", content: "NETRA-RAIL Mobile" },
